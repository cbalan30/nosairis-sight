"""
Django settings for sightproject project.
...
SECRET_KEY = 'django-insecure-#it2gm!oe5=8yfv*9#%8b5_6%xioyzf-(zw55uv=vkt9snp7*%'
...
ROOT_URLCONF = 'sightproject.urls'
...
WSGI_APPLICATION = 'sightproject.wsgi.application'
